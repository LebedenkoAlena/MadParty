...
class Organisation(models.Model):
    ...
    class2_workers_number = models.IntegerField(verbose_name="Всего человек, работающих на рабочих местах с условием труда 2 класса")
    class31_workplace_number = models.IntegerField(verbose_name="Всего рабочих мест с условием труда 3.1 класса")
    class31_workers_number = models.IntegerField(verbose_name="Всего человек, работающих на рабочих местах с условием труда 3.1 класса")
    class32_workplace_number = models.IntegerField(verbose_name="Всего рабочих мест с условием труда 3.2 класса")
    class32_workers_number = models.IntegerField(verbose_name="Всего человек, работающих на рабочих местах с условием труда 3.2 класса")
    class33_workplace_number = models.IntegerField(verbose_name="Всего рабочих мест с условием труда 3.3 класса")
    class33_workers_number = models.IntegerField(verbose_name="Всего человек, работающих на рабочих местах с условием труда 3.3 класса")
    class34_workplace_number = models.IntegerField(verbose_name="Всего рабочих мест с условием труда 3.4 класса")
    class34_workers_number = models.IntegerField(verbose_name="Всего человек, работающих на рабочих местах с условием труда 3.4 класса")
    class4_workplace_number = models.IntegerField(verbose_name="Всего рабочих мест с условием труда 4 класса")
    class4_workers_number = models.IntegerField(verbose_name="Всего человек, работающих на рабочих местах с условием труда 4 класса")
    ...
    # Working conditions
    workers_number_with_free_coveralls = models.IntegerField(verbose_name="Всего человек, бесплатно получающих СИЗ")
    ...
    workers_number_with_free_disinfectants = models.IntegerField(verbose_name="Всего человек, бесплатно получающих обеззараживающие средства")
    ...
    workers_number_with_medical_brief = models.IntegerField(verbose_name="Всего человек, прошедищих мед. осмотры")
    ...
    # Industrial injuries
    number_of_died_workers = models.IntegerField(verbose_name="Всего человек, погибших на производстве")
    died_workers_info = models.TextField(verbose_name="Информация о погибших работниках (дата, должность, возраст)")
    number_of_hard_injury = models.IntegerField(verbose_name="Всего человек, получивших тяжелые травмы на производстве")
